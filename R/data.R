...
#' Alzheimer's disease (AD) based on the [Open Access Series of Imaging
#' Studies](https://www.oasis-brains.org/) (OASIS). This set consists of a
...
#' [https://www.kaggle.com/jboysen/mri-and-alzheimers?select=oasis_longitudinal.csv](https://www.kaggle.com/jboysen/mri-and-alzheimers?select=oasis_longitudinal.csv).
...
#'
#' @format A data frame with 115 rows and 11 variables:
#' \describe{
